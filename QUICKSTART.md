...
| `[400] Tool call context circulation is not enabled` | The agent's `model:` is too old for agent transfer. Use `gemini-3.7-flash` or newer (all shipped configs already do). |
